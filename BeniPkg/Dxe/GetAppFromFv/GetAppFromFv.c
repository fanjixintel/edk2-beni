...
STATIC APP_INFO_IN_FV mApps[] = {
  ...
  // startup.nsh:
  {L"startup.nsh",                {0x5dcc1f61, 0xfcf9, 0x4158, {0x9a, 0x98, 0xdd, 0x41, 0xe2, 0x98, 0x39, 0x54}}},
  // RedfishPlatformConfig.efi:
  {L"RedfishPlatformConfig.efi",  {0xa7cc7eaf, 0x8625, 0x46b5, {0xb0, 0xc4, 0x17, 0xb1, 0x7b, 0x5c, 0x41, 0x7f}}},
  // This is the end.
  {NULL, {0}}
};
